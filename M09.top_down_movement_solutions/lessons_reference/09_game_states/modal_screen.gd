...
## Controls how much the menu is opened. This isn't actually useful, it's just
## to be able to preview it in the editor without running the game
...
func _ready() -> void:
	# This is a @tool script, so we want to test it.
